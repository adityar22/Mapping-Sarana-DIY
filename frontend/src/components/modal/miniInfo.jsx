    ...
    return (
        <div>
            <div className="container w-fit absolute z-50 top-1/2 right-0 -translate-x-1/2 -translate-y-1/2 hover:scale-105 transition-all duration-700">
                <div className="bg-white justify-content-center shadow-xl rounded-3xl px-8 pt-6 pb-8 mb-4">
                    ...
                    <div className="w-60 sm:w-96">
                        <Slide>
                            {facility.imageURL.map((imgSlide) => (
                                <img src={imgSlide} className=" w-48 h-24 sm:w-64 sm:h-32 mx-auto border rounded-xl" alt="" />
                            ))}
                        </Slide>
                    </div>
                    <h3 className="text-xl poppins font-medium mb-3 mt-4">{facility.name}</h3>
