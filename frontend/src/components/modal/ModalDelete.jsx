...
const ModalDelete = ({ handleDelete, togglePopup }) => {
    return (
        <div>
            ...
            <div className="w-max max-w-xl mx-8 bg-lightblue shadow-xl rounded-3xl px-8 pt-6 pb-8 mb-4"> 
            <h3 className="font-poppins font-semibold">Yakin ingin menghapus data Lokasi?</h3>
            <div className="flex justify-center mt-4">
                        <div className="inline-block mr-3">
                            <button
                                className="bg-gray hover:bg-gray-100 mr-3 text-white font-bold py-2 px-4 rounded focus :outline-none focus:shadow-outline"
                                onClick={togglePopup}>
                                Tidak
                            </button>
                        </div>
